...
export default function AnalyseurChequePage() {
  ...
  // ⭐ Analyseur Chèque : TOUS les CODs (test)
  const depositedParcels = useMemo(() => parcels.filter(p =>
    parseFloat(p.codAmount || 0) > 0
    // TODO: Ajouter filtre chèques/traites après test
    // && ['cheque', 'traite', 'cod_cheque', 'cod_traite'].includes(p.codPaymentType)
  ), [parcels])
        ...
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-purple-600/70 font-medium mt-0.5">
              Contrôle des chèques et traites
            </p>
            {profile?.name && (
